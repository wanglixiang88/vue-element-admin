    ...
    return new Promise(resolve => {
      ...
      getAuthMenu().then(response => {
        ...
        if (response.code !== 1000) {
          ...
          var str='{"code":1000,"message":"成功","data":[{"id":1,"name":"系统管理员","path":"","redirect":"","component":"Layout","alwaysShow":true,"meta":{"title":"系统管理员","icon":"edit"},"pid":null,"sort":0,"children":[{"id":2,"name":"用户管理","path":"index","component":"user/index","meta":{"title":"用户管理","icon":"edit"}},{"id":2,"name":"角色管理","path":"userRole","component":"user/userRole","meta":{"title":"角色管理","icon":"edit"}},{"id":3,"name":"菜单管理","path":"menu","component":"menu/index","meta":{"title":"菜单管理","icon":"edit"}},{"id":4,"name":"数据字典","path":"dictionaryIndex","component":"menu/dictionaryIndex","meta":{"title":"数据字典","icon":"edit"}},{"id":5,"name":"角色权限设置","path":"userSetRole","component":"user/setRole","meta":{"title":"角色权限设置","icon":"edit"}}]}]}';
